...
pi = read_data(file_location=file_location + r"\data", 
    name="Pi_1000")

p = read_data(file_location=file_location + r"\data", 
    name="P_1000")

fig = plt.figure(figsize=(14,5)) 
ax = fig.add_subplot(121) 
ax.plot(per, pi, c='dodgerblue', marker="o", linewidth=2)
...
ax.plot(per, p, c='dodgerblue', marker="o", linewidth=2)
...
ax.spines['top'].set_linewidth(1.5)
ax.spines['right'].set_linewidth(1.5)
plt.savefig(r".\figure\percolation-pi-p.pdf")
plt.savefig(r".\figure\percolation-pi-p.eps")
plt.show()
...
ax.scatter(percolation, y_pred, label="CNN", c='', edgecolors='dodgerblue', marker="^")
ax.scatter(percolation, y_pred_vae, label="VAE", c='', edgecolors='indianred', marker="*")
