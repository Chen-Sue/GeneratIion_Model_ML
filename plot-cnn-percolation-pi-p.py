...
plt.plot(p, y_pred_average, c='dodgerblue', label="CNNs-I", marker="o", linewidth=2)
...
plt.plot(p, y_pred_average, c='dodgerblue', label="CNNs-II", marker="o", linewidth=2)
...
plt.tight_layout()
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-pi-p.pdf")
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-pi-p.eps")
plt.show()
...
fig = plt.figure(figsize=(8,4)) 
ax = fig.add_subplot(121) 
plt.plot(p, Pi, c='grey', marker="o", label="MC 0", linewidth=2)
y_pred = model_pi_005.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='indianred', marker="*", label="CNNs-I 5%", linewidth=2)
y_pred = model_pi_010.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='dodgerblue', marker="^", label="CNNs-I 10%", linewidth=2)
y_pred = model_pi_020.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='chocolate', marker="+", 
    label="CNNs-I 20%", linewidth=2)
ax.text(0.40, 0.98, '(a)', fontsize=14)
plt.xlabel('$p$', fontsize=14)
plt.ylabel('$\Pi(p,L)$', fontsize=14)
plt.xticks(size=12)
...
# ax = fig.add_subplot(212) 
ax = fig.add_subplot(122) 
plt.plot(p, P, c='grey', marker="o", label="MC 0", linewidth=2)
y_pred = model_p_005.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='indianred', marker="*", label="CNNs-II 5%", linewidth=2)
y_pred = model_p_010.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='dodgerblue', marker="^", label="CNNs-II 10%", linewidth=2)
y_pred = model_p_020.predict(x)
y_pred_average = [y_pred[i::40] for i in np.arange(40)]
y_pred_average = np.array(y_pred_average).reshape(-1, 1000)
y_pred_average = np.mean(y_pred_average, axis=1)
plt.plot(p, y_pred_average, c='chocolate', marker="+", label="CNNs-II 20%", linewidth=2)
ax.text(0.40, 0.98, '(b)', fontsize=14)
plt.xlabel('$p$', fontsize=14)
plt.ylabel('$P(p,L)$', fontsize=14)
plt.xticks(size=12)
...
plt.subplots_adjust(left=None,bottom=None,
    right=None,top=None,wspace=0.5,hspace=None)
plt.tight_layout()
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-pi-p-noise.pdf")
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-pi-p-noise.eps")
plt.show()
...
plt.legend()
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-p.pdf")
plt.savefig(file_location + r"\VAE\figure\cnn-percolation-p.eps")
plt.show()
