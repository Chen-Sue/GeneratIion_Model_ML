...
#     name="train-cnn-p-loss", value=history.history['loss'])    
# save_data(file_location=file_location + r"\data", 
#     name="train-cnn-p-mae", value=history.history['mae'])    
# save_data(file_location=file_location + r"\data", 
#     name="train-cnn-p-rmse", value=history.history['rmse'])  
# save_data(file_location=file_location + r"\data", 
#     name="train-cnn-p-val_loss", value=history.history['val_loss'])    
# save_data(file_location=file_location + r"\data", 
#     name="train-cnn-p-val_mae", value=history.history['val_mae'])    
# save_data(file_location=file_location + r"\data", 
#     name="train-cnn-p-val_rmse", value=history.history['val_rmse'])  
