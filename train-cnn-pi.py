...
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-loss-{}".format(noise_factor), value=history.history['loss'])    
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-mae-{}".format(noise_factor), value=history.history['mae'])    
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-rmse-{}".format(noise_factor), value=history.history['rmse'])  
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-val_loss-{}".format(noise_factor), value=history.history['val_loss'])    
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-val_mae-{}".format(noise_factor), value=history.history['val_mae'])    
save_data(file_location=file_location + r"\data", 
    name="train-cnn-pi-val_rmse-{}".format(noise_factor), value=history.history['val_rmse'])  
